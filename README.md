...
- **Description:** Contains data about restaurants listed on Swiggy including:
  - Restaurant name
  - Cuisine type
  - Average price
  - Ratings
...
2. Study the relationship between pricing and customer ratings  
3. Compare ratings of Pure Veg vs Non-Veg restaurants  
...
- Popular cuisines include **North Indian, Chinese, and South Indian**
- **Pure Veg restaurants** perform comparably or slightly better than Non-Veg ones
- There is **no strong correlation** between price and ratings
